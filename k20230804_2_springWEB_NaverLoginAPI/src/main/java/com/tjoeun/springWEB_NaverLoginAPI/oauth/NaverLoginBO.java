...
// 네이버 로그인 API 등록시 발급받은 Client ID, Client Secret과 Callback URL을 입력한다.
	private final static String CLIENT_ID = "Wf1Hu0h4CssKdRk1wtfQ";
	private final static String CLIENT_SECRET = "_A7rBMVdCT";
...
// http session에 데이터 저장하는 메소드
	private void setSession(HttpSession session, String state) {
		session.setAttribute(SESSION_STATE, state);
	}	
	
// http session에 데이터 가져오는 메소드
